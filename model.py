...
class Predictor(nn.Module):
    ...
    def __call__(self, data, train=True):
        ...
        if train:
            ...
            loss_dev = Loss(predicted_interaction,correct_interaction)
            loss_dev_cpu = loss_dev.to('cpu').data.numpy()
            return loss_dev_cpu,correct_labels, predicted_labels, predicted_scores
